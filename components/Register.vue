        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form class="w-full max-w-md">
                ...
                <div class="flex items-center justify-center mt-6">
                    <a @click="() => switchAuthForm()" href="#" class="w-1/3 pb-4 font-medium text-center text-gray-400 capitalize border-b border-gray-400">
                        sign in
                    </a>

                    <a href="#" class="w-1/3 pb-4 font-medium text-center text-white capitalize border-b-2 border-white">
                        sign up
                    </a>
                </div>
                ...
                <div class="relative flex items-center mt-4">
                    ...
                    <input type="password" class="block w-full px-11 py-3 border rounded-lg bg-transparent text-gray-300 border-gray-600 focus:border-fom focus:border-fom focus:ring-fom focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Confirm Password">
                </div>
